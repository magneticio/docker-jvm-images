...
libraryDependencies ++= Seq(
  ...
  "io.fabric8" % "kubernetes-client" % "4.0.0",
  "io.fabric8" % "openshift-client" % "4.0.0",
  ...
  "me.snowdrop" % "istio-client-uberjar" % "1.0.0.Beta4",
  "me.snowdrop" % "servicecatalog-client" % "1.0.1",
